...
int main(int argc, char* argv[]) {
    ...
    // Print implicit conversions to stdout and export to JSON
    analyzer.printConversions();
    analyzer.writeConversions(conversionLogFile);
